...
var jquerypopupmenu={
	arrowpath: 'file://NIKLAS-DATOR/Hemsida/new_go_next.png', //full URL or path to arrow image
	popupmenuoffsets: [0, 0], //additional x and y offset from mouse cursor for popup menus
	animspeed: 200, //reveal animation speed (in milliseconds)
	showhidedelay: [75, 75], //delay before menu appears and disappears when mouse rolls over it, in milliseconds

	//***** NO NEED TO EDIT BEYOND HERE
	startzindex:1000,
	ismobile:navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(android)|(Samsung)|(webOS)/i) != null, //boolean check for popular mobile browsers
